...
namespace LevelEditor.Manager
{
    ...
    public class OutlineManager
    {
        ...
        public void SetRenderObjects(List<GameObject> objects)
        {
            ...
            if (objects != null) RenderObject.AddRange(objects);

            foreach (var obj in RenderObject)
            {
                if (RegisteredMeshesDic.ContainsKey(obj)) continue;
        ...
        private void LoadSmoothNormals()
        {
            ...
            foreach (var obj in RenderObject)
            {
                ...
                foreach (var meshFilter in meshFilters)
                {
                    ...
                    if (!RegisteredMeshesDic[obj].Add(meshFilter.sharedMesh)) continue;
            ...
            foreach (var obj in RenderObject)
            {
                ...
                foreach (var skinnedMeshRenderer in skinnedMeshRenderers)
                {
                    ...
                    if (!RegisteredMeshesDic[obj].Add(skinnedMeshRenderer.sharedMesh)) continue;
