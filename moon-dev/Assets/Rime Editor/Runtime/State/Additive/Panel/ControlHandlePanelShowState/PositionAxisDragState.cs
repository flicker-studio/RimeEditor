...
namespace LevelEditor
{
    public class PositionAxisDragState : AdditiveState
    {
        ...
        public PositionAxisDragState(Information information, MotionCallBack motionCallBack) : base(information, motionCallBack)
        {
            StateInit();
        }
        ...
        private void StateInit()
        {
            ...
            else if (m_information.UIManager.GetControlHandlePanel.GetPositionInputXY) m_positionDragType = POSITIONDRAGTYPE.XYAxis;

            m_originMouseWorldPosition = GetMouseWorldPoint;

            for (var i = 0; i < TargetObjs.Count; i++) m_targetOriginPosition.Add(TargetObjs[i].transform.position);
        }
