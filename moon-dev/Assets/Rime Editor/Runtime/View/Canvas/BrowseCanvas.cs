...
namespace LevelEditor.View.Canvas
{
    ...
    internal sealed class BrowseCanvas : ICanvas
    {
        ...
        public BrowseCanvas([NotNull] RectTransform rect)
        {
            ...
            uiProperty            = RimeEditor.Runtime.RimeEditor.Configure.UI.GetLevelManagerPanelUI.GetLevelManagerPanelUIName;
            PopoverProperty       = RimeEditor.Runtime.RimeEditor.Configure.UI.GetPopoverProperty;
        ...
        {
            var pre = Resources.Load<GameObject>("Prefabs/LevelItem");
        ...
        {
            _activeEntry.Open();
            RimeEditor.Runtime.RimeEditor.Instance.StateSwitch<EditorState>();
        }
