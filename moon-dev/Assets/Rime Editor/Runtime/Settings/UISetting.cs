...
namespace LevelEditor
{
    ...
    public class UISetting : ScriptableObject
    {
        ...
        {
            [field: SerializeField]
            [field: CustomLabel("选择框最小检测尺寸")]
            public Vector2 SELECTION_MIN_SIZE { get; private set; }

            [field: SerializeField]
            [field: CustomLabel("选择框颜色")]
        ...
        {
            [field: SerializeField]
            [field: CustomLabel("缩放轴拖拽速度")]
            [field: Range(0.01f, 1)]
            public float SCALE_SPEED { get; private set; }

            [field: SerializeField]
            [field: CustomLabel("中心点轴显示补偿")]
            [field: Range(0.01f, 5)]
        ...
        {
            [field: SerializeField]
            [field: CustomLabel("鼠标光标边界检测距离补偿")]
        ...
        public struct LevelSettingPanelUIName
        {
            ...
            [field: SerializeField]
            [field: CustomLabel("关卡设置面板名字")]
            public string SETTING_PANEL { get; private set; }

            [field: SerializeField]
            [field: CustomLabel("关闭按钮名字")]
        ...
        {
            [field: SerializeField]
            [field: CustomLabel("检视面板根节点名字")]
            public string INSPECTOR_ROOT { get; set; }

            [field: SerializeField]
            [field: CustomLabel("检视面板内容名字")]
            public string INSPECTOR_CONTENT { get; set; }

            [field: SerializeField]
            [field: CustomLabel("描述内容名字")]
        ...
        {
            [field: SerializeField] [field: CustomLabel("布尔项文字名字")]
