...
namespace RimeEditor.Editor
{
    ...
    public class GlobalSettingProvider : SettingsProvider
    {
        ...
        private bool[] _folds = { true, true, true, true, true, true };
        ...
        public override void OnGUI(string searchContext)
        {
            ...
            GlobalSettingEditor.OnGUI(_serializedSetting, ref _folds);
        ...
        private static SettingsProvider RegisterSettingsProvider()
        {
            ...
            if (_serializedSetting != null) provider.keywords = GetSearchKeywordsFromGUIContentProperties<Styles>();
