...
namespace UnityToolkit.Editor
{
    static internal class ScrollListMenuOptions
    {
        ...
        {
            GameObject go = ScrollListDefaultControls.CreateLoopHorizontalScrollRect(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }

        [MenuItem("GameObject/UI/Loop Vertical Scroll Rect")]
        public static void AddLoopVerticalScrollRect(MenuCommand menuCommand)
        {
            GameObject go = ScrollListDefaultControls.CreateLoopVerticalScrollRect(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
    }
}