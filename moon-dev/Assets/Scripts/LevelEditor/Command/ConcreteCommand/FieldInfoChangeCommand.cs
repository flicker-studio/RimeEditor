...
namespace LevelEditor
{
    ...
    {
        private readonly List<AbstractItem>                       m_targetList       = new();
        ...
        public FieldInfoChangeCommand(List<AbstractItem>                       targetList, List<FieldInfo> targetFieldInfos, object nextValue,
