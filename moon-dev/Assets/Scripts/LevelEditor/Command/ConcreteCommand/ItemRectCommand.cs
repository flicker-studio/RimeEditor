...
{
    public class ItemRectCommand : ICommand
    {
        ...
        public ItemRectCommand(ObservableList<ItemDataBase> itemDatas, List<Vector3> lastPosition, List<Vector3> nextPosition, List<Vector3> lastScale, List<Vector3> nextScale)
        {
