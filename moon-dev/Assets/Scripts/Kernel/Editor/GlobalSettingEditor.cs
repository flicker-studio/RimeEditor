...
namespace Moon.Kernel.Editor
{
    ...
    {
        private bool[] m_folds = new bool[5];
        ...
        public override void OnInspectorGUI()
        {
            ...
            OnGUI(serializedObject, ref m_folds);
        ...
        public static void OnGUI(SerializedObject serialized, ref bool[] folds)
        {
            ...
            if (folds[2])
            {
                EditorGUILayout.PropertyField(serialized.FindProperty("screenSizeStandard"));
            }
            ...
            if (folds[3])
            {
                EditorGUILayout.PropertyField(serialized.FindProperty("itemFilePath"));
            }
