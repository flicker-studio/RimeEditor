...
{
    public abstract class ServiceControlManager
    {
        ...
        {
            if (RunningServices.Contains(service)) throw new Exception();
        ...
        {
            if (!RunningServices.Contains(service)) throw new NullReferenceException();
