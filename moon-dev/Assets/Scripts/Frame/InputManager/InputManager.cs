...
namespace Frame.Tool
{
    public class InputManager : MonoSingleton<InputManager>, IAutoCreateSingleton
    {
        ...
        private Input<Vector2> m_moveInput;

        private Input<bool> m_jumpInput;

        private Input<bool> m_runInput;

        private Input<bool> m_sliceInput;
        ...
        private Input<bool> m_mouseLeftButton;

        private Input<bool> m_mouseRightButton;

        private Input<bool> m_mouseMiddleButton;

        private Input<float> m_mouseScroll;

        private Input<bool> m_shiftButton;

        private Input<bool> m_ctrlButton;

        private Input<bool> m_zButton;

        private Input<bool> m_cButton;

        private Input<bool> m_vButton;

        private Input<bool> m_gButton;

        private Input<bool> m_pButton;

        private Input<bool> m_rButton;

        private Input<bool> m_sButton;

        private Input<bool> m_deleteButton;

        private Input<bool> m_escapeButton;
        ...
        private Input<bool> m_num1;

        private Input<bool> m_num2;

        private Input<bool> m_num3;

        private Input<bool> m_num4;

        private Input<bool> m_num5;
