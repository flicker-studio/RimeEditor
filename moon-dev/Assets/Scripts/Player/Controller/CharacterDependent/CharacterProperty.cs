...
namespace Character
{
    ...
    public class CharacterProperty : SettingBase
    {
        ...
        [Header("角色跳跃属性")] public PlayerJumpProperty JumpProperty;

        [Header("地面检测参数")] public PlayerGroundCheckParameter GroundCheckParameter;

        [Header("顶头检测参数")] public PlayerCeilingCheckParameter CeilingCheckParameter;

        [Header("地面IK参数")] public PlayerPerpendicularOnGround PerpendicularOnGround;
        ...
        public struct PlayerMoveProperty
        {
            ...
            [CustomLabel("速度变化曲线")] public AnimationCurve ACCELERATION_CURVE;
        }
        ...
        public struct PlayerJumpProperty
        {
            ...
            [CustomLabel("跳跃缓冲时间"), Range(0, 10)] public float JUMPING_BUFFER_TIME;

            [CustomLabel("土狼时间"), Range(0, 1)] public float COYOTE_TIME;
        ...
        {
            [CustomLabel("检测点数量"), Range(1, 50)] public int CHECK_RAYCAST_POINTS;

            [CustomLabel("忽略点数量"), Range(0, 10)] public int NEGLECTED_POINTS;
            ...
            [CustomLabel("发射线补偿坐标")] public Vector2 START_POINT_COMPENSATION;
        }
    }
}